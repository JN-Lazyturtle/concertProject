 ...
 */
final class Version20230123143205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist ADD picture_a VARCHAR(255) NOT NULL, CHANGE summary_a summary_a VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artist DROP picture_a, CHANGE summary_a summary_a VARCHAR(255) DEFAULT \'NULL\'');
    }
}
