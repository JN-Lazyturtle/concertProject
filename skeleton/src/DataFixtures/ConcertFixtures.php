...
class ConcertFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $concert1->setConcertHall($this->getReference(ConcertHallFixtures::PETIOLE));
        ...
        $concert2->setConcertHall($this->getReference(ConcertHallFixtures::SCALAIRE));
        ...
        $concert3->setConcertHall($this->getReference(ConcertHallFixtures::SCALAIRE));
